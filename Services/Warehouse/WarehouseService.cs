...
// using WarehouseManager.Services.Validators;
//
...
//     {
//         var createFolderValidator = new WarehouseValidator();
//         if (!(await createFolderValidator.ValidateAsync(dto)).IsValid)
//             throw new System.Exception(ExceptionState.CheckUrFiled);
//
